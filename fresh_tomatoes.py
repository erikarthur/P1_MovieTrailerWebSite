...
# three column template on desktop.  Image on left and movie metadata on right.
movie_tile_content = '''
    <div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
        <div class="left-image">
            <img class="box-image" src="{box_image_url}">
        </div>
        <div class="right-text">
            <div class="text-left bold">{movie_title}</div>
            <div class="text-left">{movie_date}, {movie_length} min.</div>
            ...
            <div class="text-left">
                ...
                <div>
                    ...
                    <span class="normal">{movie_imdb_rating}</span>
                </div>
            </div>
        </div>
    </div>
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        # added length, rating, date, imdb rating
