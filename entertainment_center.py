...
the_dark_knight = media.Movie("152", "PG-13", "The Dark Knight", "2008", "8.8",
                              """When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, the
                              caped crusader must come to terms with one of the greatest psychological tests of his
...
aliens = media.Movie("137", "R", "Aliens", "1986", "8.4",
                     """The planet from Alien has been colonized, but contact is lost. This time, the rescue team has
...
full_metal_jacket = media.Movie("116", "R", "Full Metal Jacket", "1987", "8.3",
                                ...
                                on his fellow recruits from their brutal boot camp training to the bloody street
                                fighting in Hue.""",
...
unforgiven = media.Movie("131", "R", "Unforgiven", "1992", "8.2",
                         """Retired Old West gunslinger William Munny reluctantly takes on one last job, with the help
...
jurassic_park = media.Movie("127", "PG-13", "Jurassic Park", "1993", "8",
                            """During a preview tour, a theme park suffers a major power breakdown that allows its
...
movies.extend(
    [the_matrix, aliens, full_metal_jacket, unforgiven, jurassic_park, toy_story, avatar, caddyshack, the_godfather])
